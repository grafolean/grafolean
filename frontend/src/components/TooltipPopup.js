    ...
    return (
      <div
        style={{
          ...
          position: 'relative',
          transform: `translate(-${this.props.arrowPercentFromLeft}%, ${
            this.props.isArrowOnTop ? 0 : -100
          }%)`,
      ...
      >
        ...
        <div
          style={{
            ...
            margin: this.props.isArrowOnTop
              ? `${this.props.arrowSpacingVertical} 0 0 0`
              : `0 0 ${this.props.arrowSpacingVertical} 0`,
          }}
        >
          {/* Content: */}
          <div
          ...
          >
            ...
            <div
              style={{
                border: '0 solid transparent',
                borderWidth: arrowBorderWidth,
                [this.props.isArrowOnTop ? 'borderBottomColor' : 'borderTopColor']: this.props
                  .backgroundColor,
                position: 'absolute',
                width: 0,
                marginLeft: isArrowOnRight
                  ? -this.props.borderWidth - arrowWidth - this.props.borderWidth
                  : 0,
